...
function Map() {
  return (
    <div className="map-container" style={{ position: "relative", zIndex: 1 }}>
      <div className="map_area mx-4" id="map" style={{ position: "relative", zIndex: 0 }}>
        <iframe
          title="map"
      ...
      <div className="location_information bg-bgc wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s" style={{ position: "relative", zIndex: 2 }}>
        <h3>XTASY</h3>
